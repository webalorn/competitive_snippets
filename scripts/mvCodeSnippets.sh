...
then
      ...
      cp generated/vscodeSnippets/competitive_snippets.code-snippets "$VSCODE_SNIPPETS/competitive_snippets.code-snippets" && echo "competitive_snippets.code-snippets has been copied in $VSCODE_SNIPPETS"
fi